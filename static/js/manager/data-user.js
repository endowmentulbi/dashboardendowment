import { UrlDonasiPospay, requestOptionsGet, requestOptionsDelete } from "../controller/template.js";

// Fetch Data User
document.addEventListener('DOMContentLoaded', function() {
    fetch(UrlDonasiPospay, requestOptionsGet)
    ...
    function updateTable(data) {
        ...
        data.data.forEach((user, index) => {
            ...
            row.innerHTML = `
                ...
                <td class="fw-bolder text-gray-500">${user.transaction_id}</td>
...
function deleteUser(id) {
    fetch(UrlDonasiPospay + `/${id}`, requestOptionsDelete)
        .then((response) => response.json())
        .then((data) => {
